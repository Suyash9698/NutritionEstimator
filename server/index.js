...
const railwayMongoURI = "mongodb://mongo:yjGwbgPGhaccwOnaEtdfweAcdRnVFTlr@roundhouse.proxy.rlwy.net:58512";
...
const userConnection = mongoose.createConnection(railwayMongoURI, { dbName: 'SuyashLabData' });
const suyashLab3rdConnection = mongoose.createConnection(railwayMongoURI, { dbName: 'userNutritionCalories' });


userConnection.on('connected', () => {
  console.log("Connected to Railway MongoDB for user data");
});
suyashLab3rdConnection.on('connected', () => {
  console.log("Connected to Railway MongoDB for calorie data");
});
...
const Calorie = suyashLab3rdConnection.model("Calorie", calorieSchema);
...
form.parse(req, (err, fields, files) => {
 ...
 // const filePath = "/Users/suyash9698/desktop/2023202017today/client/src/image.jpeg"; 
  ...
  const pythonScriptPath = "/Users/suyash9698/desktop/NUTRITION_ESTIMATOR/client/src/newtest.py"; 
